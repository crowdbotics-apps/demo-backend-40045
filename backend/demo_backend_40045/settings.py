"""
Django settings for demo_backend_40045 project.
...
ROOT_URLCONF = 'demo_backend_40045.urls'
...
WSGI_APPLICATION = 'demo_backend_40045.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_backend_40045 API",
    "DESCRIPTION": "API documentation for demo_backend_40045 App",
    "VERSION": "v1",
}
